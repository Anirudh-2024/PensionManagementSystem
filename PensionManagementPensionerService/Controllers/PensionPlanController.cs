    ...
    public class PensionPlanController : ControllerBase
    {
        ...
        public async Task<ActionResult<IEnumerable<PensionPlanDetails>>> GetAllPensionPlans()
        {
            try
            {
                ...
                _logger.LogInformation("Successfully retrieved all pensionplan details: {@result}", result);
                return Ok(result);
            }
            catch (EmptyResultException ex)
            {
                _logger.LogInformation("Empty result returned while retrieving pensionplan details");
        ...
        public async Task<IActionResult> GetPensionPlanById(Guid pensionPlanId)
        {
            try
            {
                ...
                _logger.LogInformation("Successfully retrieved pension plan details by Pensionplan Id : {@result}", result);
                return Ok(result);
            }
            catch (NotFoundException ex)
            {
                _logger.LogInformation("No pension plan details found.");
                return NotFound(ex.Message);
            }
            catch (Exception ex)
            {
        ...
        public async Task<ActionResult<PensionPlanDetails>> AddPensionPlan([FromBody] PensionPlanDetails pensionPlanDetails)
        {
            try
            {
                ...
                _logger.LogInformation("Successfully added pension plan details {@result}", result);
                return Ok(result);
        ...
        public async Task<IActionResult> UpdatePensionPlanById(Guid pensionPlanId, [FromBody] PensionPlanDetails pensionPlanDetails)
        {
            try
            {
                ...
                _logger.LogInformation("Successfully updated pensionplan details by Pensionplan Id: {@result}", result);
                return Ok(result);
            }
            catch (NotFoundException ex)
            {
        ...
        public async Task<IActionResult> DeletePensionPlanById(Guid pensionPlanId)
        {
            try
            {
                ...
                _logger.LogInformation("Successfully deleted pensioneplan details by Pensionplan Id.");
                return NoContent();
             }
            catch (NotFoundException ex)
            {
